...
export default function Result() {
  ...
  return (
    <div className="h-full flex flex-col p-4 sm:p-6 lg:p-8 bg-slate-50 overflow-hidden print:p-0 print:bg-white print:h-auto print:overflow-visible">
      {/* Header - Compact */}
      <div className="flex justify-between items-center mb-4 shrink-0 print:hidden">
        ...
        <div className="flex items-center gap-3">
          <button onClick={handlePrint} className="flex items-center gap-2 text-sm font-medium text-slate-700 hover:text-slate-900 px-4 py-2 border border-slate-300 bg-white rounded-lg transition-colors">
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-6 min-h-0 print:block print:w-full">
        {/* Left Column: Image & Verdict (approx 35%) */}
        <div className="w-full lg:w-[35%] flex flex-col gap-4 min-h-0 print:w-full print:mb-6">
          <div className="glass-card p-4 shrink-0 border-l-4" style={{ borderLeftColor: isGolden ? '#10b981' : isSparse ? '#f59e0b' : '#ef4444' }}>
            ...
            <div className="bg-slate-50 p-3 rounded-lg border border-slate-100 print:border-none print:bg-white">
        ...
        <div className="flex-1 flex flex-col gap-4 min-h-0 print:w-full print:block">
          {/* Top Row: Fraud & Scores */}
          <div className="flex flex-col sm:flex-row gap-4 shrink-0 print:block">
            <div className="glass-card p-4 flex-1 print:mb-4">
            ...
            <div className="glass-card p-4 flex-[1.5] print:mb-4">
          ...
          <div className="glass-card p-4 shrink-0 flex flex-col print:mb-4">
            <h3 className="font-semibold text-slate-900 text-sm mb-3">Economic Fusion Engine</h3>
            
            <div className="bg-white border border-slate-200 p-4 rounded-lg mb-4 text-sm">
              <div className="mb-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-slate-50 rounded-lg p-3 border border-slate-100 flex flex-col justify-center print:bg-white print:border-none">
          ...
          <div className="glass-card p-4 flex-1 flex flex-col min-h-0 print:h-64">
            <h3 className="font-semibold text-slate-900 text-sm mb-2 shrink-0">Store Vitality Profile</h3>
            <div className="flex-1 flex flex-col sm:flex-row min-h-0">
              ...
              <div className="flex-1 h-full min-h-[150px] border-t sm:border-t-0 sm:border-l border-slate-100 pt-4 sm:pt-0 sm:pl-4">
                <h4 className="text-xs font-medium text-slate-500 text-center mb-2">Peer Benchmarking (Est. Daily Sales)</h4>
                <ResponsiveContainer width="100%" height="100%">
